...
questao_02_linha.py
-------------------
Questão 2 da Atividade 1 – TI0166
...
def E_analitico_linha(Q, L, rho):
    """
    Campo radial de uma linha finita de comprimento L,
    centrada na origem, em ponto a distância radial ρ no plano médio.
...
def campo_linha_pontual(N, Q, L, P):
    """
    Modela a linha como N cargas pontuais igualmente espaçadas
    (centros dos segmentos) e calcula E em P por superposição.
    """
